...
This file and any architecture decision record that defines this rule must name
the prohibited terms explicitly. Mechanical checks for these terms do not apply
